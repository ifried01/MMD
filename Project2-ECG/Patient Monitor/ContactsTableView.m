...
@interface ContactsTableView () <MFMessageComposeViewControllerDelegate>
...
{
    [super viewDidLoad];
    self.names = [[NSMutableArray alloc] initWithObjects: @"Dr. Ming Chow", @"Dr. Bernard Johnson", @"Dr. Ronald Lasser", nil];
    self.numbers = [[NSMutableArray alloc] initWithObjects: @"1", @"2", @"5", nil];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *selectedFile = [self.names objectAtIndex:indexPath.row];
